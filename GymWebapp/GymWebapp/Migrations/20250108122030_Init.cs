    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BougthTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BougthTickets_TicketTypes_TicketTypeId",
                        column: x => x.TicketTypeId,
                        principalTable: "TicketTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BougthTickets_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BougthTickets_TicketTypeId",
                table: "BougthTickets",
                column: "TicketTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_BougthTickets_UserId",
                table: "BougthTickets",
                column: "UserId");
